...
public class ExplosionAnimator extends ValueAnimator {
    ...
    private static final float X = Util.dp2Px(5);
    private static final float Y = Util.dp2Px(20);
    private static final float V = Util.dp2Px(2);
    private static final float W = Util.dp2Px(1);
